...
var _StorageError = _interopRequireDefault(require("./StorageError.js"));
...
class Storage extends Map {
  ...
  constructor(options) {
    ...
    super();
    if (options?.size && typeof options?.size !== "number") new _StorageError.default(`'${options?.size}' is not Number.`, {
      name: "TypeError"
    }).throw();
